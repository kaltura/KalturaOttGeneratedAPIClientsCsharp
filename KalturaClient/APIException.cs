...
namespace Kaltura
{
	public class APIException : ApplicationException
	{
		...
		public static string CannotDeleteAssetStruct = "4098";
		public static string CategoryTypeNotExist = "4099";
		public static string ExtendedTypeValueCannotBeChanged = "4100";

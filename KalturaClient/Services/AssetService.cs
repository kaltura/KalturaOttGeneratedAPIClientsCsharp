...
namespace Kaltura.Services
{
	public class AssetCountRequestBuilder : RequestBuilder<AssetCount>
	{
		...
		public AssetCountRequestBuilder(IList<AssetGroupBy> groupBy, SearchAssetFilter filter)
			: this()
		{
	...
	public class AssetService
	{
		...
		public static AssetCountRequestBuilder Count(IList<AssetGroupBy> groupBy, SearchAssetFilter filter = null)
		{
			return new AssetCountRequestBuilder(groupBy, filter);
		}

...
namespace Kaltura.Services
{
	public class SessionCreateSessionCharacteristicRequestBuilder : RequestBuilder<SessionCharacteristic>
	{
		...
		public SessionCreateSessionCharacteristicRequestBuilder(string userId, int householdId, string udid, long expiration, int regionId, IDictionary<string, StringValueArray> sessionCharacteristicParams)
			: this()
		{
			this.UserId = userId;
	...
	public class SessionService
	{
		...
		public static SessionCreateSessionCharacteristicRequestBuilder CreateSessionCharacteristic(string userId, int householdId, string udid, long expiration, int regionId = Int32.MinValue, IDictionary<string, StringValueArray> sessionCharacteristicParams = null)
		{

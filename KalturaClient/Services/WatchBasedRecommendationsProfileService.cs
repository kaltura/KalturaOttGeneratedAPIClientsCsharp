...
namespace Kaltura.Services
{
	...
	public class WatchBasedRecommendationsProfileDeleteWatchBasedRecommendationsOfProfileRequestBuilder : RequestBuilder<VoidResponse>
	{
		#region Constants
		public const string ID = "id";
		#endregion
		...
		public WatchBasedRecommendationsProfileDeleteWatchBasedRecommendationsOfProfileRequestBuilder()
			: base("watchbasedrecommendationsprofile", "deleteWatchBasedRecommendationsOfProfile")
		{
		}

		public WatchBasedRecommendationsProfileDeleteWatchBasedRecommendationsOfProfileRequestBuilder(long id)
			: this()
		{
			this.Id = id;
		}
	...
	public class WatchBasedRecommendationsProfileService
	{
		...
		public static WatchBasedRecommendationsProfileDeleteWatchBasedRecommendationsOfProfileRequestBuilder DeleteWatchBasedRecommendationsOfProfile(long id)
		{
			return new WatchBasedRecommendationsProfileDeleteWatchBasedRecommendationsOfProfileRequestBuilder(id);
		}

...
namespace Kaltura.Services
{
	...
	public class SemanticAssetSearchPartnerConfigGetSearchableAttributesRequestBuilder : RequestBuilder<SearchableAttributes>
	{
		...
		public string AssetStructId { get; set; }
		...
		public SemanticAssetSearchPartnerConfigGetSearchableAttributesRequestBuilder(string assetStructId)
			: this()
		{
	...
	public class SemanticAssetSearchPartnerConfigService
	{
		...
		public static SemanticAssetSearchPartnerConfigGetSearchableAttributesRequestBuilder GetSearchableAttributes(string assetStructId)
		{

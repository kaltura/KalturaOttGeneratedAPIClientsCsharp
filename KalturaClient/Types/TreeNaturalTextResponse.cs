...
{
	public class TreeNaturalTextResponse : ObjectBase
	{
		#region Constants
		...
		public TreeNaturalTextResponse(JToken node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaTreeNaturalTextResponse");

...
{
	public class EnrichedMetadataResult : ObjectBase
	{
		#region Constants
		...
		public EnrichedMetadataResult(JToken node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaEnrichedMetadataResult");

...
{
	public class HouseholdPartnerConfiguration : ObjectBase
	{
		#region Constants
		...
		public HouseholdPartnerConfiguration(JToken node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaHouseholdPartnerConfiguration");

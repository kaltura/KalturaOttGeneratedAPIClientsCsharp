...
{
	public class ExpressionAnd : UserSessionProfileExpression
	{
		#region Constants
		...
		#region Properties
		/// <summary>
		/// Use ExpressionsAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		public ExpressionAnd(JToken node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaExpressionAnd");

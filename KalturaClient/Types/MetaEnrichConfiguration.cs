...
{
	public class MetaEnrichConfiguration : ObjectBase
	{
		#region Constants
		...
		public MetaEnrichConfiguration(JToken node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaMetaEnrichConfiguration");

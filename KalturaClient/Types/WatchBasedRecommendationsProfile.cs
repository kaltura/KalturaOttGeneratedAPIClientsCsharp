...
namespace Kaltura.Types
{
	public class WatchBasedRecommendationsProfile : ObjectBase
	{
		...
		public const string RECOMMENDATIONS_MEDIA_TYPE_IDS = "recommendationsMediaTypeIds";
		public const string RECOMMENDATIONS_SERIES_INFO = "recommendationsSeriesInfo";
		#endregion
		...
		private string _RecommendationsMediaTypeIds = null;
		private SeriesInfo _RecommendationsSeriesInfo;
		#endregion
		...
		/// <summary>
		/// Use RecommendationsMediaTypeIdsAsDouble property instead
		/// </summary>
		[JsonProperty]
		public string RecommendationsMediaTypeIds
		{
			get { return _RecommendationsMediaTypeIds; }
			set 
			{ 
				_RecommendationsMediaTypeIds = value;
				OnPropertyChanged("RecommendationsMediaTypeIds");
			}
		}
		/// <summary>
		/// Use RecommendationsSeriesInfoAsDouble property instead
		/// </summary>
		[JsonProperty]
		public SeriesInfo RecommendationsSeriesInfo
		{
			get { return _RecommendationsSeriesInfo; }
			set 
			{ 
				_RecommendationsSeriesInfo = value;
				OnPropertyChanged("RecommendationsSeriesInfo");
			}
		}
		#endregion
		...
		public WatchBasedRecommendationsProfile(JToken node) : base(node)
		{
			...
			if(node["recommendationsMediaTypeIds"] != null)
			{
				this._RecommendationsMediaTypeIds = node["recommendationsMediaTypeIds"].Value<string>();
			}
			if(node["recommendationsSeriesInfo"] != null)
			{
				this._RecommendationsSeriesInfo = ObjectFactory.Create<SeriesInfo>(node["recommendationsSeriesInfo"]);
			}
		}
		#endregion
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			kparams.AddIfNotNull("recommendationsMediaTypeIds", this._RecommendationsMediaTypeIds);
			kparams.AddIfNotNull("recommendationsSeriesInfo", this._RecommendationsSeriesInfo);
			return kparams;
		}
		protected override string getPropertyName(string apiName)
		{
			switch(apiName)
			{
				...
				case RECOMMENDATIONS_MEDIA_TYPE_IDS:
					return "RecommendationsMediaTypeIds";
				case RECOMMENDATIONS_SERIES_INFO:
					return "RecommendationsSeriesInfo";
				default:

...
{
	public class FilterFileByDynamicDataAction : FilterAction
	{
		#region Constants
		...
		public FilterFileByDynamicDataAction(JToken node) : base(node)
		{
			if(node["key"] != null)
			{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaFilterFileByDynamicDataAction");

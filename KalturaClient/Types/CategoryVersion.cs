...
{
	public class CategoryVersion : OTTObjectSupportNullable
	{
		#region Constants
		...
		/// <summary>
		/// Use BaseVersionIdAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		/// <summary>
		/// Use CategoryRootIdAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		/// <summary>
		/// Use DefaultDateAsDouble property instead
		/// </summary>
		[JsonProperty]
		...
		/// <summary>
		/// Use UpdaterIdAsDouble property instead
		/// </summary>
		[JsonProperty]

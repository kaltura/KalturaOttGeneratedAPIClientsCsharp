...
{
	public class BaseBulkUploadSegmentsResult : BulkUploadResult
	{
		#region Constants
		...
		public BaseBulkUploadSegmentsResult(JToken node) : base(node)
		{
		...
		public override Params ToParams(bool includeObjectType = true)
		{
			...
			if (includeObjectType)
				kparams.AddReplace("objectType", "KalturaBaseBulkUploadSegmentsResult");

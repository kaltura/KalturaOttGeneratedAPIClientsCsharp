...
namespace Kaltura.Types
{
	public class MessageTemplate : ObjectBase
	{
		...
		private MessageTemplateType _MessageType = (MessageTemplateType)Int32.MinValue;
			...
			foreach (XmlElement propertyNode in node.ChildNodes)
			{
				switch (propertyNode.Name)
				{
					...
					case "dateFormat":
						...
						continue;
					case "messageType":
						this._MessageType = (MessageTemplateType)ParseEnum(typeof(MessageTemplateType), propertyNode.InnerText);
						continue;
					case "sound":
